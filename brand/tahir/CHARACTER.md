...
Tahir (طاهر — "pure") is the mascot and personification of Tahir's List (tahirslist.com). He is the user's knowledgeable friend — the guy who knows which spots are legit. He is warm, cheerful, curious, and quietly proud of doing verification right. He is never sarcastic, never preachy, never an authority figure — a friendly peer.

## Canonical look (do not deviate)
...
| Background | Flat pale sky-blue (canonical); transparent/plain when composited into product UI |
...
- Empty state: "Tahir couldn't find any hand-cut spots here yet. Help him add one?"
- Verification pending: "Tahir is checking the certificate… 🔍"
- Verified: "Tahir checked — the certificate's legit. ✓"
- Unverified listing: "Tahir hasn't verified this one yet — it might still be great."
