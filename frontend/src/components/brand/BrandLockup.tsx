...
/**
 * Wordmark "Tahir's List" — Archivo 800 (font-display extrabold), tight
 * tracking (-0.03em), ink-900 on paper; the apostrophe is always brand red
 * (#C6381F / brand-500). Size is left to the consumer via `className`.
 */
export function Wordmark({ className = "" }: { className?: string }) {
  return (
    <span
      className={`font-display font-extrabold tracking-[-0.03em] text-ink-900 ${className}`}
    >
