 ...
 * [app.halal.application.image.InMemoryImagePort] so the app boots for dev/test
 * without MinIO.
 */
...
class S3ImagePortConfig {
    ...
    @Bean
    fun imagePort(s3: S3Client, props: S3StorageProperties): app.halal.application.image.ImagePort =
